...
## Project Structure
    ...
    ├── cooking_with_freind_36962  # Django project configurations
...
1. Clone this repo and `cd cooking_with_freind_36962`
...
2. Clone this repo and `cd cooking_with_freind_36962`
